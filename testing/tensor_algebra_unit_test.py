...
class TestTensorAlgebra(unittest.TestCase):
    ...
    def test_recouple_ABxCD_ACxBD(self):
        ...
        self.assertEqual('1 * {{q_1 x q_1}_0 x {sig1_1 x sig2_1}_0}_0'
                         + ' + sqrt(5) * {{q_1 x q_1}_2 x {sig1_1 x sig2_1}_2}_0',
                         str(TensorAlgebra._recouple_ABxCD_ACxBD(operator)))

        operator = TensorFromVectors.scalar_product(self.qxk, self.sig1). \
            couple(TensorFromVectors.scalar_product(self.qxk, self.sig2), 0, 1)
        self.assertEqual('-2 * {{{k_1 x q_1}_1 x {k_1 x q_1}_1}_0 x {sig1_1 x sig2_1}_0}_0'
    ...
    def test_recouple_N3LO_central(self):
        ...
        self.assertEqual('-6 * {{{k_1 x q_1}_1 x {k_1 x q_1}_1}_0 x {sig1_1 x sig2_1}_0}_0',
                         str(TensorAlgebra.recouple(operator)))
    ...
    def test_recouple_N3LO_spin_orbit(self):
        ...
        self.assertEqual('3*sqrt(2)/2 * {{{k_1 x q_1}_1 x {q_1 x q_1}_0}_1 x sig1_1}_0',
                         str(TensorAlgebra.recouple(operator)))

        operator = I / 2 * TensorFromVectors.scalar_product(self.sig1, self.qxk).couple(self.ksq, 0, 1)
        self.assertEqual('3*sqrt(2)/2 * {{{k_1 x k_1}_0 x {k_1 x q_1}_1}_1 x sig1_1}_0',
                         str(TensorAlgebra.recouple(operator)))
    ...
    def test_recouple_N3LO_tensor(self):
        ...
        self.assertEqual('-sqrt(3) * {{{q_1 x q_1}_0 x {q_1 x q_1}_0}_0 x {sig1_1 x sig2_1}_0}_0'
                         + ' + -sqrt(15) * {{{q_1 x q_1}_2 x {q_1 x q_1}_0}_2 x {sig1_1 x sig2_1}_2}_0',
                         str(TensorAlgebra.recouple(operator)))

        operator = self.qs1.couple(self.qs2, 0, 1).couple(self.ksq, 0, 1)
        self.assertEqual('-sqrt(3) * {{{k_1 x k_1}_0 x {q_1 x q_1}_0}_0 x {sig1_1 x sig2_1}_0}_0'
        ...
        self.assertEqual('-sqrt(3) * {{{k_1 x k_1}_0 x {k_1 x k_1}_0}_0 x {sig1_1 x sig2_1}_0}_0'
    ...
    def test_three_spaces(self):
        ...
        self.assertEqual('-3*sqrt(3) * {{{k_1 x k_1}_0 x {sig1_1 x sig2_1}_0}_0 x {P_1 x P_1}_0}_0',
                         str(TensorAlgebra.recouple(operator)))

        operator = TensorFromVectors.scalar_product(self.kxP, self.kxP).couple(self.ssq, 0, 1)
        self.assertEqual('-2*sqrt(3) * {{{k_1 x k_1}_0 x {sig1_1 x sig2_1}_0}_0 x {P_1 x P_1}_0}_0'
        ...
        self.assertEqual('-2 * {{{{k_1 x q_1}_1 x q_1}_0 x {sig1_1 x sig2_1}_1}_1 x P_1}_0'
        ...
        operator = TensorFromVectors.scalar_product(self.qxP, self.sig1). \
            couple(TensorFromVectors.scalar_product(self.qxP, self.sig2), 0, 1)
        self.assertEqual('-2*sqrt(3)/3 * {{{q_1 x q_1}_0 x {sig1_1 x sig2_1}_0}_0 x {P_1 x P_1}_0}_0'

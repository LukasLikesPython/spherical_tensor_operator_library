...
class TestTensorAlgebra(unittest.TestCase):
    ...
    def test_reouple_ABxC_AxBC(self):
        ...
        self.assertEqual(
            'sqrt(3)/3 * {q_1 x {sig1_1 x sig2_1}_0}_1 + -1 * {q_1 x {sig1_1 x sig2_1}_1}_1 + sqrt(15)/3 * {q_1 x {sig1_1 x sig2_1}_2}_1',
    ...
    def test_recouple_NLO_tensor(self):
        ...
        operator = self.qs1.couple(self.qs2, 0, 1)
        self.assertEqual('1 * {{q_1 x q_1}_0 x {sig1_1 x sig2_1}_0}_0 + sqrt(5) * {{q_1 x q_1}_2 x {sig1_1 x sig2_1}_2}_0',
                         str(TensorAlgebra.recouple(operator)))
        operator = self.ks1.couple(self.ks2, 0, 1)
        self.assertEqual('1 * {{k_1 x k_1}_0 x {sig1_1 x sig2_1}_0}_0 + sqrt(5) * {{k_1 x k_1}_2 x {sig1_1 x sig2_1}_2}_0',
                         str(TensorAlgebra.recouple(operator)))
    ...
    def test_complicated_recouple(self):
        ...
        operator = TensorFromVectors.scalar_product(self.qxk, self.sig1).couple(self.ksq, 0, I / 2)
        self.assertEqual(
            '3*sqrt(2)/2 * {{{k_1 x k_1}_0 x {k_1 x q_1}_1}_1 x sig1_1}_0',
            str(TensorAlgebra.recouple(operator)))
